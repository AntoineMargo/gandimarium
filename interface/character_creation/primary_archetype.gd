...
@onready var battle_mage_button = $ArchetypeTabs/Archetype/VBoxContainer/HBoxContainer/Archetypes/BattleMage
...
func _on_battle_mage_button_button_pressed():
	root.data.major_archetype = load("res://resources/archetypes/battle_mage.tres")
...
func _ready() -> void:
	...
	battle_mage_button.pressed.connect(_on_battle_mage_button_button_pressed)
