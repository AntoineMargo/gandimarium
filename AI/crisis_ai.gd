...
func plan_turn():
	...
	if not report["closest_enemy"]:
		...
		return
	var _sequence =  htn.produce_sequence(report)
...
#func add_weapon_entries(entries):
	...
	#if weapons[0]:
		#if weapons[0].throw and weapons[0].throw.activity.reach > 1:
			#entries.append(weapons[0].throw)
		#if weapons[0].shoot:
			#entries.append(weapons[0].shoot)
		#else:
			#entries.append(weapons[0].strike)
#
	#if weapons[1]:
		#if weapons[1].throw and weapons[0].throw.activity.reach > 1:
			#entries.append(weapons[1].throw)
		#if weapons[1].shoot:
			#entries.append(weapons[1].shoot)
		#else:
			#entries.append(weapons[1].strike)
